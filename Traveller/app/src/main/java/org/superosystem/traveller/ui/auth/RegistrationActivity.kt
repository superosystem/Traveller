package org.superosystem.traveller.ui.auth
...
import org.superosystem.traveller.databinding.ActivityRegistrationBinding
...
class RegistrationActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(p0: View?) {
        when (p0?.id) {
            ...
            R.id.eula_hyperlink -> {
                //go to eula page
                startActivity(Intent(this@RegistrationActivity, EulaActivity::class.java))
            }
        }
    }
    ...
    private fun observerRegis(
        dataRegis: HashMap<String, String>,
        dataLogin: HashMap<String, String>
    ) {
        viewModel.registerUser(dataRegis).observe(this) { response ->
