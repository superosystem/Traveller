...
from core.dataset import AlignCollate, SingleDataset, tensorflow_dataloader
from core.utils import CTCLabelConverter
...
def index():
    if request.method == "POST":
        ...
        with open("./ktp/" + filename, "r") as openfile:
            file_json = json.load(openfile)

        try:
            prediction = predict(file_json)
            return prediction
