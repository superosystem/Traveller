...
import (
	...
	"github.com/superosystem/TrainingSystem/backend/controller/mentees/request"
	"github.com/superosystem/TrainingSystem/backend/controller/mentees/response"
...
func NewMenteeController(menteeUsecase mentees.Usecase, jwtConfig *helper.JWTConfig) *MenteeController {
