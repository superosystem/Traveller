...
import (
	...
	"github.com/superosystem/TrainingSystem/backend/controller/categories/request"
	"github.com/superosystem/TrainingSystem/backend/controller/categories/response"
