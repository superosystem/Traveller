...
from core.dataset import AlignCollate, hierarchical_dataset, tensorflow_dataloader
from core.model import Model
from core.modules.custom import custom_sparse_categorical_crossentropy
from core.utils import Averager, CTCLabelConverter
...
# python test.py --test_data result --valid_data result --select_data / --batch_ratio 0.5 --batch_size 2 --character 'abcdefghijlkmnopqrstuvwxyz,. -' --num_iter 60000 --Transformation None --FeatureExtraction VGG --SequenceModeling None --Prediction CTC
# python test.py --test_data result --valid_data result --select_data / --batch_ratio 0.5 --batch_size 2 --character '0123456789' --num_iter 60000 --Transformation None --FeatureExtraction ResNet --SequenceModeling None --Prediction CTC
